...
// function testAssemlingError(line: string) {
...
//     testAssemlingError('rd;rd');
//     testAssemlingError('wr;rd');
//     testAssemlingError('wr;wr');
// });

// test('Jumps', () => {
//     testAssembleSuccess(';;goto 4;', 0x6000_0004);
//     testAssembleSuccess('goto   255;;', 0x6000_00ff);
//     testAssemlingError('goto -1');
//     testAssemlingError('goto 256');
